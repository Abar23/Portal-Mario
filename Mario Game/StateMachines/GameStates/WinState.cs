...
{
    class WinState : GameState, IRestartable
    {
        ...
        public WinState(GameState previousState, MarioGame game, IController<Keys> keys, IController<Buttons> gamePad) : base(game, keys, gamePad)
        {
            this.previousState = previousState;
            this.splashTexture = game.Content.Load<Texture2D>("Textures/Win");
        }
